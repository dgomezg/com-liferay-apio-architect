...
public class CollectionRoutes<T, S> {
	...
	public static class Builder<T, S> {
		...
		public Builder(
			String name, Function<String, Optional<String>> nameFunction,ProvideFunction provideFunction,
		...
		public <F, E, I extends Identifier> CollectionRoutes.Builder addCustomRoute(
...
//					items -> new Page(
//						_name, items, pagination, _getOperations(null))
//				).apply(
//					pagination
//				));
//
...
//				new Form.Builder<>(Arrays.asList("c", name), _identifierFunction));
//
				...
				stringCreateItemFunctionMap -> stringCreateItemFunctionMap.entrySet(
					...
					formedRouteBiFunctionEntry -> {
						...
						Operation operation = new Operation(
							...
							_name, formedRoute.getName(), true, true);
